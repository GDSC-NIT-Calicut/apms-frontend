...
export default function Dashboard({setIsLoggedIn}:DashboardProps) {
  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-grow flex mt-2 ml-40 mr-40 gap-[20%]">
      ...
      <footer className="-mt-4 px-6 py-[32px] bg-gradient-to-b from-[#241515] to-[#141a2e] border-t-[2px] border-[rgba(38,134,255,0.4)] w-full min-h-16 relative">
